document.addEventListener('DOMContentLoaded', () => {
    ...
    const memories = {
      ...
      "두끼": {
            ...
            "14": {
                main: "엽떡이 질릴 때, 두끼도 진짜 많이 갔다. 가격도 저렴한데 무한리필이라는 장점은 떡볶이를 좋아하는 여중딩들에게 최고의 식당이다.",
                sub: "#2025년 현재까지도 남아있는 장소 #두끼는 제발 망하지 않았으면 #두끼 현재도 좋아함"
            }
        },
    ...
    function updateMap(age) {
        ...
        // 📌 핵심 수정: <img> 태그의 src 속성 변경 (SVG 적용)
